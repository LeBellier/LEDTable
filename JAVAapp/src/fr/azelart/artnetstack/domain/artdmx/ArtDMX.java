...
public class ArtDMX extends ArtNetObject {
     ...
     * correct order. When Art-Net is carried over a medium such as the
     * Internet, it is possible that ArtDmx packets will reach the receiver out
     * of order.
     */
    ...
    /**
     * The physical input port from which DMX512 data was input. This field is
     * for information only. Use Universe for data routing.
     */
    ...
    /**
     * The length of the DMX512 data array. This value should be an even number
     * in the range 2 // 512. It represents the number of DMX512 channels
     * encoded in packet. NB: Products which convert Art-Net to DMX512 may opt
     * to always send 512 channels. High Byte
     */
